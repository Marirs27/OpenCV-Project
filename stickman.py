...
def Make_Canvas(coordinates1 , coordinates2) :
    draw_stickman(C,coordinates1,background,"enable_swords")
    draw_stickman(C,coordinates2,background,"enable_swords")
    C.pack()
    root.mainloop()
...
Make_Canvas(Raise_swords_coordinates,Shealth_swords_coordinates)